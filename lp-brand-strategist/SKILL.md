...
description: >
  Extract complete brand identity for landing page creation. Activate when user wants to create
  a landing page, website, or sales page and needs to capture company information first.
  Conducts a deep-dive brand interview covering company identity, founder story, brand voice,
  visual assets, and social proof. Outputs a structured Brand Brief document.
  Part of the Landing Page Pipeline (Phase 0, Agent 1 of 3).
---
