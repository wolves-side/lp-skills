...
name: lp-master
description: >
  Skill orquestradora do pipeline AILD completo. Gerencia a execução sequencial de todas
  as skills do repositório, do ICP Discovery até o Deploy. Cada fase tem inputs definidos,
  outputs esperados, e checkpoints de qualidade que devem ser aprovados antes de avançar.
  Use esta skill quando um cliente pedir "crie uma landing page" — ela conduz TODO o processo.
metadata:
  author: "[Your Name/Company]"
  version: "1.0.0"
  phase: "Master — Orchestrator"
---
...
|-------|------|------|----------|
| `lp-icp-discovery` | 1 | Interativa | `fase-1-pesquisa-icp/lp-icp-discovery/SKILL.md` |
| `lp-brand-strategist` | 2 | Interativa | `fase-2-empresa-produto/lp-brand-strategist/SKILL.md` |
| `lp-product-architect` | 2 | Interativa | `fase-2-empresa-produto/lp-product-architect/SKILL.md` |
| `lp-competitive-intel` | 2 | Automática | `fase-2-empresa-produto/lp-competitive-intel/SKILL.md` |
| `lp-brief-synthesizer` | 2 | Automática | `fase-2-empresa-produto/lp-brief-synthesizer/SKILL.md` |
| `lp-copywriter` | 3 | Automática | `fase-3-estrategia-copy/lp-copywriter/SKILL.md` |
| `lp-page-architect` | 3 | Automática | `fase-3-estrategia-copy/lp-page-architect/SKILL.md` |
| `lp-page-spec-assembler` | 3 | Automática | `fase-3-estrategia-copy/lp-page-spec-assembler/SKILL.md` |
| `lp-design-system` | 4 | Automática | `fase-4-design-system/lp-design-system/SKILL.md` |
| `lp-page-builder` | 5 | Automática | `fase-5-desenvolvimento/lp-page-builder/SKILL.md` |
| `lp-page-qa` | 6, 7 | Automática | `fase-6-analise-critica/lp-page-qa/SKILL.md` |
| `lp-expert-panel` | 6 | Automática | `fase-6-analise-critica/lp-expert-panel/SKILL.md` |
| `lp-page-rebuild` | 7 | Automática | `fase-7-revisao-final/lp-page-rebuild/SKILL.md` |
| `lp-deployment` | 8 | Interativa | `fase-8-deploy/lp-deployment/SKILL.md` |
