...
description: >
  Build a complete, production-ready landing page as a single HTML file. Activate when the
  Page Specification (Phase 1) and Design System (Phase 2) are complete, or when user has a
  spec and design tokens ready for implementation. Generates semantic HTML, responsive CSS,
  scroll animations, form handling, and all copy verbatim from the spec. Outputs a
  self-contained HTML file ready for deployment.
