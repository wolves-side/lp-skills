...
description: >
  Map products/services and architect the offer strategy for landing page creation. Activate
  after brand-strategist completes, or when user wants to define what a landing page will sell,
  its offer structure, guarantee, objections, and conversion mechanics. Covers product mapping,
  offer construction, and campaign objective definition.
  Part of the Landing Page Pipeline (Phase 0, Agent 2 of 3).
---
