...
description: >
  Research and analyze competitors for landing page differentiation. Activate after brand-strategist
  identifies competitors, or when user wants competitive analysis for LP positioning. Scrapes
  competitor landing pages, analyzes copy/design/offers, identifies market patterns and
  exploitable gaps. Outputs a Competitive Analysis document.
  Part of the Landing Page Pipeline (Phase 0, Agent 3 of 3).
---
